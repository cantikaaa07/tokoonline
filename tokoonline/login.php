              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="varchar" class="form-control" name="username" id="username" placeholder="username" required>
                ...
                <div class="text-right mt-4">
                  <a href="tambah_pelanggan.php" class="btn btn-back float-end text-danger">Registrasi</a>
                </div>
              </div>
            </form>
            </div>
